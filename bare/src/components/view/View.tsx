...
const View = <T extends React.ElementType = typeof DEFAULT_ELEMENT>({
  ...
  const viewClassName = clsx(
    ...
    borderColorStyles[borderColor ?? 'gray-3'],
    shadow && styles.shadow,
    !scrollbar && styles.noScrollbar,
    hoverTarget && hoverStyles[`${hoverTarget}-parent` as keyof typeof hoverStyles],
    hoverParent && hoverStyles[`${hoverParent}-child` as keyof typeof hoverStyles],
