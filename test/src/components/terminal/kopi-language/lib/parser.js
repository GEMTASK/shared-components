...
function peg$parse(input, options) {
  ...
  var peg$e45 = peg$otherExpectation("space");
  var peg$e46 = peg$literalExpectation(" ", false);
  var peg$e47 = peg$otherExpectation("whitespace");
  var peg$e48 = peg$otherExpectation("comment");
  ...
  var peg$f5 = function(head, consequent, alternate) {
      return {
  ...
  var peg$f12 = function(leftExpression, rightExpression) {
      return {
        type: 'OperatorExpression',
        operator: "^",
        leftExpression,
  ...
  var peg$f37 = function(operator, argumentExpression) {
      return {
        type: 'AstLiteral',
        value: {
          type: 'ApplyExpression',
  ...
  function peg$parseExponentExpression() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        s5 = peg$parseExponentExpression();
        if (s5 !== peg$FAILED) {
          peg$savedPos = s0;
          s0 = peg$f12(s1, s5);
        } else {
