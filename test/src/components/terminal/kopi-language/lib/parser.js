...
function peg$parse(input, options) {
  ...
  var peg$f8 = function(pattern, defaultExpression) {
      return {
        ...pattern,
        defaultExpression,
      }
