...
function peg$parse(input, options) {
  ...
  var peg$e47 = peg$otherExpectation("operator");
  var peg$e48 = peg$otherExpectation("typename");
  ...
  var peg$f14 = function(parameterPattern, predicateExpression, bodyExpression) {
      return {
        type: "FunctionExpression",
        parameterPattern,
  ...
  var peg$f24 = function(name, expression) {
      return {
        name: name && name[0].name,
        expression
      }
    };
  var peg$f25 = function(statements) {
    return statements;
  };
  ...
  var peg$f27 = function(pattern, defaultExpression) {
      return {
        ...pattern,
        defaultExpression,
      }
  ...
  var peg$f29 = function(colon, head, tail) {
  ...
  var peg$f30 = function(typename, argumentPattern) {
      return {
  ...
  var peg$f32 = function(init, head, tail, rest) {
    return {
      type: 'ArrayLiteralPattern',
  ...
  var peg$f42 = function(operator, argumentExpression) {
      return {
        type: 'AstLiteral',
        value: {
          type: 'ApplyExpression',
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s7 !== peg$FAILED) {
          ...
          if (s10 !== peg$FAILED) {
            s11 = peg$parse_();
            s12 = peg$parseIdentifierPattern();
            if (s12 !== peg$FAILED) {
              s9 = [s9, s10, s11, s12];
              s8 = s9;
            } else {
